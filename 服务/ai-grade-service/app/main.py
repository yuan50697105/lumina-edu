...
from .routers import router as grade_router

logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s [%(process)d] %(levelname)s %(name)s: %(message)s",
)
logger = logging.getLogger("lumina.ai-grade")

SERVICE_NAME = "ai-grade-service"
...
app = FastAPI(
    title="Lumina 墨光 · AI 批阅服务 API",
    description="AI 辅助批阅 · 结构化成绩写入 grades 表",
